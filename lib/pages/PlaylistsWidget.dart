...
import 'package:mzansibeats/pages/list_songs.dart';

class PlaylistWidget extends StatefulWidget {
  final DatabaseClient db;
  PlaylistWidget(this.db);
...
class _StatePlaylist extends State<PlaylistWidget> {
  var mode;
  List<Song> songs;
  var selected;
  ...
  _lengthFind() async {
    ...
    setState(() {
      atThir = songs.length != 0
          ? "Includes ${songs[songs.length != 1 ? random.nextInt(songs.length-1) : 0].artist.toString()} and more"
          : atThird;
    });
